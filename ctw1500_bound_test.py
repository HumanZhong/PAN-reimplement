...
def test(args):
    ...
    for idx, (img, original_img) in tqdm(enumerate(testloader)):
        ...
        outputs = (torch.sign(outputs - 0.5) + 1) / 2
        ...
        generate_img_result(original_img, image_name, 'outputs/result_ctw_img_my_top&bot_erodedwidth20_0401_unmasked_thres0')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--resume', nargs='?', type=str, default='/home/data1/zhm/ctw_purebound_checkpoint_erodedwidth20_0401_300e.pth.tar')
