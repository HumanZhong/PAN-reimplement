...
class FPEM_FFM(nn.Module):
    def __init__(self, backbone_out_channels, num_classes=6, **kwargs):
        """
        PANnet
        ...
        self.out_conv = nn.Conv2d(in_channels=conv_out * 4, out_channels=self.num_classes, kernel_size=1)
