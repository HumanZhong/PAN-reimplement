...
def predict(args):
    ...
    for idx, (img, original_img) in tqdm(enumerate(testloader)):
        ...
        generate_txt_result_PAN(bboxes, image_name, 'outputs/result_ic15_txt_PAN_baseline600_v4_4_90_7')
        generate_img_result(original_img, image_name, 'outputs/result_ic15_img_PAN_baseline600_v4_4_90_7')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--resume', nargs='?', type=str, default='/home/data1/zhm/ic15_PAN_baseline_Poly_v4.pth.tar')
