...
from dataset import CTW1500Trainset_Corner
...
def main(args):
    ...
    trainset = CTW1500Trainset_Corner()
    ...
    for epoch in range(n_epoch):
        ...
        torch.save(checkpoint_info, '/home/data1/zhm/ctw_corner_checkpoint_0325_100e.pth.tar')

if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    parser.add_argument('--backbone', nargs='?', type=str, default='res50')
    parser.add_argument('--schedule', nargs='+', type=int, default=[80, 150])
